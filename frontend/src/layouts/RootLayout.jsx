      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <header className="px-6 sm:px-10 py-4 flex items-center justify-between">
          ...
          <nav className="hidden sm:flex items-center gap-4 text-xs text-gray-400">
            <span className={pathname === "/" ? "text-teal-300" : ""}>Home</span>
            <span className={pathname.startsWith("/login") ? "text-teal-300" : ""}>Login</span>
            <span className={pathname.startsWith("/quiz") ? "text-teal-300" : ""}>Quiz</span>
          </nav>
        </header>
